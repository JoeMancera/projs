...
class Ads{
    ...
    // creamos una lista de Ads para devolver
    private ads: Ad[];
    ...
    // va a validar si tenemos una instancia, si no la va a crear
    static getInstance(){
        if(!Ads.instance){
    ...
    // Inicializamos el arreglo de ads
    private initAds(){
        // los tres piuntos es descructuring y se 'dejan caer' en otra caja o arreglo
        this.ads = [ ...ALL_ADS ];
